    ...
    $.ajax({
        ...
        success: function (data) {
			if(data==0){
				Swal.fire({
	                icon: 'error',
	                title: 'El administrador ya esta registrada',
	            ...
	            Swal.fire({
	                icon: 'success',
	                title: 'Se ha '+texto+' el administrador',
	                showConfirmButton: false,
	                timer: 1500
	            })
	            clear();
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(js, function (a, b) {
                t.row.add([b.id, b.email,b.password, botonera]);
...
$(document).ready(function () {
    ...
    $("#tablaListado").DataTable({
        language: {
            ...
            zeroRecords: "No se encontraron administrador",
    ...
    $(document).on('click', '.eliminar', function () {
        Swal.fire({
            ...
            text: "¿Esta seguro de querer eliminar esta administrador?",
            icon: 'warning',
